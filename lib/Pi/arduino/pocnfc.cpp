...
/*
  ...
  */
  ...
  /*
  *  Upgrade on 2013/08
  *  Author: Paul Parisot, INTENT TECHNOLOGIES
  */
...
uint8_t address2 = 0x05;//Address to read.
uint8_t address3 = 0x06;//Address to read.
...
void loop()
{
	...
	//Read from address after authentication
		...
		printf("ID: ");
		print(aux , 16);
		ofstream fichier("/home/pi/logg.json", ios::out);
		wchar_t temp[16];
		for(int i=0;i<16;i++){
		temp[i]=aux[i];
		}
